...
def get_target_model(target_name, device):
    ...
    elif "resnet18_cifar_t0" in target_name:
    ...
    elif "resnet18_cifar_t1" in target_name:
        target_model = resnet18(nclasses=100)
        path = '/data/output-ai/shruthi.gowda/continual/base_aug/results/class-il/seq-cifar100/derpp/derpp-base-aug-model-200-seq-cifar100-s1/net_1.pth'
        target_model = torch.load(path).to(device) #['state_dict']
        target_model.eval()
        preprocess = get_resnet_cifar_preprocess()
    elif "resnet18_cifar_t2" in target_name:
        target_model = resnet18(nclasses=100)
        path = '/data/output-ai/shruthi.gowda/continual/base_aug/results/class-il/seq-cifar100/derpp/derpp-base-aug-model-200-seq-cifar100-s1/net_2.pth'
        target_model = torch.load(path).to(device) #['state_dict']
        target_model.eval()
        preprocess = get_resnet_cifar_preprocess()
    elif "resnet18_cifar_t3" in target_name:
        target_model = resnet18(nclasses=100)
        path = '/data/output-ai/shruthi.gowda/continual/base_aug/results/class-il/seq-cifar100/derpp/derpp-base-aug-model-200-seq-cifar100-s1/net_3.pth'
        target_model = torch.load(path).to(device) #['state_dict']
        target_model.eval()
        preprocess = get_resnet_cifar_preprocess()
    elif "resnet18_cifar_t4" in target_name:
        target_model = resnet18(nclasses=100)
        path = '/data/output-ai/shruthi.gowda/continual/base_aug/results/class-il/seq-cifar100/derpp/derpp-base-aug-model-200-seq-cifar100-s1/net_4.pth'
        target_model = torch.load(path).to(device) #['state_dict']
        target_model.eval()
        preprocess = get_resnet_cifar_preprocess()
